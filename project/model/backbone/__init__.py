...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, output_stride, ibn_mode='none',renet = 'resnet101'):
        ...
        self.layer4 = self._make_layer(block, 512, layers[3], stride=strides[3], dilation=dilations[3], ibn_mode=ibn_mode)
...
def build_backbone(backbone, output_stride, ibn_mode, BatchNorm):
    ...
    load_pretrained_model(model, url='https://download.pytorch.org/models/resnet101-5d3b4d8f.pth')
    return model
